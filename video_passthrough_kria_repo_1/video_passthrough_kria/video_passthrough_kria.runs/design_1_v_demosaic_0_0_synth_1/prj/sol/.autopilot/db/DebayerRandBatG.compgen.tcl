...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_demosaic_0_0_DebayerRandBatG_lineBuffer_val_V_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bayerPhase_c_dout { I 16 vector } bayerPhase_c_num_data_valid { I 2 vector } bayerPhase_c_fifo_cap { I 2 vector } bayerPhase_c_empty_n { I 1 bit } bayerPhase_c_read { O 1 bit } } \
} "
}
