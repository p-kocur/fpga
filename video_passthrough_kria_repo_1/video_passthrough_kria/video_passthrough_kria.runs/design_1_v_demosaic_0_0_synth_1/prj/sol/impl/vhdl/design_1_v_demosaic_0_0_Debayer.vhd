...
attribute shreg_extract : string;
    ...
    signal imgG_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgG_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgG_empty_n : STD_LOGIC;
    signal bayerPhase_c9_full_n : STD_LOGIC;
    signal bayerPhase_c9_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal bayerPhase_c9_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal bayerPhase_c9_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal bayerPhase_c9_empty_n : STD_LOGIC;
    signal imgRB_full_n : STD_LOGIC;
    signal imgRB_dout : STD_LOGIC_VECTOR (29 downto 0);
    signal imgRB_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgRB_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgRB_empty_n : STD_LOGIC;
    signal bayerPhase_c_full_n : STD_LOGIC;
    signal bayerPhase_c_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal bayerPhase_c_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal bayerPhase_c_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    bayerPhase_c9_U : component design_1_v_demosaic_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
