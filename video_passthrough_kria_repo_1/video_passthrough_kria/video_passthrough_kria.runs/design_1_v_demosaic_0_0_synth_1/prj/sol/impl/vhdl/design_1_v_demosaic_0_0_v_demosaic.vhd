...
architecture behav of design_1_v_demosaic_0_0_v_demosaic is 
    ...
    "design_1_v_demosaic_0_0_v_demosaic,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.920000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=30,HLS_SYN_DSP=0,HLS_SYN_FF=10214,HLS_SYN_LUT=11585,HLS_VERSION=2022_2}";
    ...
    signal AXIvideo2MultiBayer_U0_imgBayer_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal AXIvideo2MultiBayer_U0_imgBayer_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal bayer_phase_assign_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal bayer_phase_assign_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal imgRgb_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgRgb_empty_n : STD_LOGIC;
    signal imgUnzip_full_n : STD_LOGIC;
    signal imgUnzip_dout : STD_LOGIC_VECTOR (29 downto 0);
    signal imgUnzip_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgUnzip_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component design_1_v_demosaic_0_0_Block_entry1_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    ...
    Block_entry1_proc_U0 : component design_1_v_demosaic_0_0_Block_entry1_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2MultiBayer_U0_imgBayer_fifo_cap <= imgBayer_fifo_cap(2 - 1 downto 0);
    AXIvideo2MultiBayer_U0_imgBayer_num_data_valid <= imgBayer_num_data_valid(2 - 1 downto 0);
